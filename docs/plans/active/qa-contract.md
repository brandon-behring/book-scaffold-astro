...
selected book; it never replaces the individual book results.
...
3. a two-book corpus reports independent counts and a named aggregate;
...
6. `init-qa` is deterministic, network-free, and overwrite-safe; and
